 ...
 * 三方库的 {@link Ability} 也不例外, 但三方库的适配参数可能和自己项目中的适配参数不一致, 导致三方库的适配效果和理想的效果差别很大
 ...
 * ================================================
 */
public class ExternalAdaptInfo implements Serializable {
//public class ExternalAdaptInfo {
    /**
